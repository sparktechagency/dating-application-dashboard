...
import {  useGetMediaPolicyQuery,   useUpdateMediaPolicyMutation } from "../../redux/api/SettingApi";

const MediaPolicy = () => {
    const { data: getPrivacy } = useGetMediaPolicyQuery();
          const [updatePrivacy] = useUpdateMediaPolicyMutation();
