    ...
    <div className='bg-white rounded-md p-4'>
      ...
      <div className="flex justify-between item-center pb-8">
        <div className="flex items-center gap-2">
          ...
          <span className=' text-[20px]'>Host Information</span></div>
        <div>
        ...
        <Tab req={'DJ Request'} info={'All Dj Info'} setTab={setTab} tab={tab} />
        <div className='mt-10'>
            {
                tab ? <div>
                <p className='text-2xl mb-5'>Show All DJ's Request</p>
                <HostCard/>
            </div> : <div>
                <p className='text-2xl mb-5'>All DJ's Information</p>
