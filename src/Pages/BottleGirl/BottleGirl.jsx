    ...
    <div className='bg-white rounded-md p-4'>
      ...
      <div className="flex justify-between item-center pb-8">
        <div className="flex items-center gap-2">
          ...
          <span className=' text-[20px]'>Bottle Girl Information</span></div>
        <div>
        ...
        <Tab req={'Bottle Girl Request'} info={'All Bottle Girl Info'} setTab={setTab} tab={tab} />
        <div className='mt-10'>
            {
                tab ? <div>
                <p className='text-2xl mb-5'>Show All Bottle Girl Request</p>
                <HostCard/>
            </div> : <div>
                <p className='text-2xl mb-5'>All Bottle Girl Information</p>
